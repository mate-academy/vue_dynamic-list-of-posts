...
<template>
	<div class="content">
		<form @submit.prevent="emit('create', authorName, authorEmail, textAreaValue)">
			<div class="tile is-parent is-8-desktop Sidebar Sidebar--open">
				<div class="content">
					<InputField placeholder="Name Surname" name="Author name" v-model:data="authorName" />
					<InputField placeholder="Your email" name="Author email" v-model:data="authorEmail" />
					<textAreaField placeholder="Comment body" name="Write comment body" v-model:data="textAreaValue" />
					<div class="field is-grouped">
						<div class="control">
