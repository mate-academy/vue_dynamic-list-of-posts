...
<template>
    <div className="field" data-cy="NameField">
        ...
        <div className="control has-icons-left has-icons-right">
            <input type="text" :name="name" id="{`comment-author-name-${name}`}" placeholder="Name Surname"
                class="input" :class="{ 'is-danger': nameError }" v-model.trim="name" />
        ...
        <p className="help is-danger" data-cy="ErrorMessage" v-if="nameError">
            Name is required
        </p>
    </div>
    ...
    <div className="field" data-cy="NameField">
        ...
        <div className="control has-icons-left has-icons-right">
            <input type="email" name="{email}" id="{`comment-author-email-${email}`}" placeholder="Your email"
                class="input" :class="{ 'is-danger': emailError }" v-model.trim="email" />
            <span className="icon is-small is-left">
        ...
        <p className="help is-danger" data-cy="ErrorMessage" v-if="emailError">
            Email is required
        </p>
    </div>
    ...
    <div class="field" data-cy="BodyField">
        ...
        <p className="help is-danger" data-cy="ErrorMessage" v-if="bodyError">
            Body is required
        </p>
    </div>
