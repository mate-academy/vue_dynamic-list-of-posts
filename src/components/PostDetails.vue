...
export default {
  ...
  methods: {
    // Carrega os comentários do post quando selecionado
    async loadComments() {
    ...
    // Lida com a exclusão otimista de comentários
    async handleDeleteComment(commentId) {
      // Exclusão otimista: removemos da tela antes mesmo da API confirmar
      ...
      try {
        ...
        // Restaurar o comentário em caso de falha na API
        if (deletedComment) {
    ...
    // Atualiza o modo local e emite para o pai que o post foi atualizado
