  ...
  <div class="content">
    ...
    <form @submit.prevent="submit">
      <div class="field">
        ...
        <p v-if="submitAttempted && errors.title" class="help is-danger">
          {{ errors.title }}
        </p>
      </div>
      ...
      <div class="field">
        ...
        <div class="control">
          <textarea v-model="form.body" class="textarea" rows="4" />
        </div>
        <p v-if="submitAttempted && errors.body" class="help is-danger">
          {{ errors.body }}
        </p>
      </div>
